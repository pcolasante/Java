...
public class Test {
	...
	public static void main(String[] args) {
		...
		//to output the interfaces
		System.out.println(" ");
		System.out.println("Would you like to learn the life span of these animals (Y or N):");
		System.out.println(" ");
		...
		if (answer == 'N') {
			...
			displayAvgLifeSpan(max);
			displayAvgLifeSpan(lily);
			displayAvgLifeSpan(ave);
		} else {
			System.out.println("Invalid input");
		}

		System.out.println(" ");
		System.out.println("Would you like to learn the gestation period of these animals (Y or N):");
		System.out.println(" ");
		...
		if (answer == 'N') {
			...
			showGestationPeriod(max);
			showGestationPeriod(lily);
			showGestationPeriod(ave);
		} else {
			System.out.println("Invalid input");
		}
	}
	...
	public static void displayAvgLifeSpan (LifeSpan lifeValue) {
		
		System.out.println(" ");
		lifeValue.averageLifeSpan();
		
	}
	
	public static void showGestationPeriod (GestationPeriod timeGestate) {
		System.out.println();
		timeGestate.periodGestation();
	}
}
